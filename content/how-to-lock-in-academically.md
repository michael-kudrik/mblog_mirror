...
::nuxt-img{src="https://raw.githubusercontent.com/michael-kudrik/BlogPosts/main/images/sceneAtTheSeaPainting.jpg" alt="painting of scene at the sea"}
::
...
::nuxt-img{src="https://raw.githubusercontent.com/michael-kudrik/BlogPosts/main/images/monkeytype.png" alt="monkeytype screenshot"}
::

## Note Taking 

Note taking is a very subjective topic as everyone has their own ways of doing it. You may be the good old pen and paper enjoyer, or opt for a more modernized approach like a tablet. Regardless, I will be discussing the method I use for taking notes in my classes and why I think it is one of the best methods especially if you use the computer as your chosen note taking tool.
...
I referenced [this tutorial](https://www.youtube.com/watch?v=QWYG_67ADv4) when I set up my Obsidian vault.
...
::nuxt-img{src="https://raw.githubusercontent.com/michael-kudrik/BlogPosts/main/images/obsidianExample2.png" alt="obsidian screenshot"}
::
...
This tends to be my go to for every subject, as it seems to be a surefire method to memorize and understand concepts. [Give it a peek](https://studykit.app/).

::nuxt-img{src="https://raw.githubusercontent.com/michael-kudrik/BlogPosts/main/images/studyKit.png" alt="StudyKit screenshot"}
::
...
::nuxt-img{src="https://raw.githubusercontent.com/michael-kudrik/BlogPosts/main/images/study.jpg" alt="Golden Boy!"}
::
